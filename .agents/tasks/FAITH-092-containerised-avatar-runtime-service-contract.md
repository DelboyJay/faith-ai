...
- Create a dedicated avatar runtime container contract for health, session lifecycle, speech playback requests, and avatar animation or viseme events.
...
2. The runtime exposes a stable local API or WebSocket contract for health, speech playback, and avatar animation metadata.
